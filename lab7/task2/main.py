...
def main():
    traveler = Character("Traveler", 5, "Sword", "Unknown")
    kazuha = PlayableCharacter("Kazuha", 5,  "Sword", "Inazuma", "Event")
    raiden_boss = Boss("Magatsu Mitake Narukami no Mikoto",  "Inazuma", 
